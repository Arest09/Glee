...
if (document.querySelector('.product-tabs__top')) {
  ...
  tabs.addEventListener('click', (event) => {
    ...
    if (event.target.closest('.product-tabs__item')) {
      event.target.closest('.product-tabs__item').classList.add('product-tabs__item--active');
    }
    ...
    document.querySelector(`${id}`).classList.add('product-tabs__content-item--active');
  })
}
...
document.querySelector('.menu__btn').addEventListener('click',()=>{
  ...
  document.querySelector('.menu__item').classList.toggle('menu__item--active')
})